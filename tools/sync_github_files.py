...
def sync_github_files():
    print("☁️  SYNCHRONIZING GITHUB FILES TO GOLDEN STATE...")

    # --- 1. FIX ENGINE (Unified Ranking + Soft Trend) ---
...
def calculate_backtest_quality_score(row, strategy_name):
    # UNIFIED VELOCITY RANKING (The 'Goldilocks' Math)
    score = 50.0
    ...
    # 2. Velocity Booster (Moderate +15)
...
"""
    with open(engine_path, "w") as f:
        f.write(engine_code)
    print("   ✅ Engine Synced: Unified Velocity Ranking Restored.")

    # --- 2. FIX EVOLUTION (Profit Tuning) ---
...
"""
    ...
    print("\n✅ SYNC COMPLETE.")
    print("   1. Execution/Engine.py -> Updated (Velocity + Trend + TieBreaker)")
    print("   2. optimization/evolution.py -> Profit Target Mutation logic synced")
