...
def calculate_backtest_quality_score(row, strategy_name):
    # UNIFIED VELOCITY RANKING
    score = 50.0
    
    # 1. Base Oversold (Dip Buying) - Can add +190 points easily
    ...
    # CRITICAL FIX: DO NOT CLAMP SCORE TO 100
    # Let it go to 200+ so the best dips sort to the top.
    return score
