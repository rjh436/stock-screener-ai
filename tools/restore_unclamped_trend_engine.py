...
def calculate_backtest_quality_score(row, strategy_name):
    # UNIFIED RANKING (Unclamped + Trend + Velocity)
    score = 50.0
    ...
    # 3. Soft Trend Filter (The Quality Bias)
    # This was critical for Machine Gun (43%) and apparently helps Gen 12 (49%)
    # by picking high-quality pullbacks instead of crashes.
