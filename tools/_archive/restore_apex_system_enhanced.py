...
def calculate_backtest_quality_score(row, strategy_name):
    # --- GOLDEN STATE ENGINE v2 (Enhanced) ---
    score = 50.0
    ...
    # Includes robust tags ("Gen12" and "Gen 12")
    ...
    # Includes robust tags ("Gen9" and "Gen 9") and DOWNTREND PENALTY
    income_tags = ["Income", "Gen9", "Gen 9", "MachineGun", "Evolved"]
    ...
    # Forces tie-breaking via Volatility/Trend instead of raw RSI depth.
    ...
    for current_dt in all_dates:
        ...
        if cash > 0:
            ...
            for sym, df in enriched.items():
                ...
                # Use i-1 for signal (Close of yesterday)
