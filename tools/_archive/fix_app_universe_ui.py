...
# --- 2. BACKTEST ---
    ...
    # Universe Selection (Restored & Defaulted to S&P 1500)
    ...
    **Execution:** Managed as *Gen 12* (Let it Run).
    ...
    if st.session_state.super_signal_res:
        ...
        if not trades_df.empty:
            ...
            st.download_button("📥 Download Super Signal Trades", csv, "super_signals.csv", "text/csv", key="dl_super")
