...
def restore_apex_system_final():
    print("💎 EXECUTING FINAL APEX RESTORATION (Audit-Verified)...")
...
"""
    with open(engine_path, "w") as f:
        f.write(engine_code)
    print("   ✅ Engine Restored: Clamped, Robust Tags, Downtrend Penalty.")
    ...
    if os.path.exists(app_path):
        ...
        # Force default index=2 (S&P 1500)
    ...
    print("\n🚀 SYSTEM FULLY RESTORED. PLEASE RUN BACKTEST.")


if __name__ == "__main__":
    restore_apex_system_final()
