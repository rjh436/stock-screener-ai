...
def fix_backtest_persistence():
    print("💾 FIXING BACKTEST PERSISTENCE (Stop Disappearing Output)...")
...
"""
    ...
    with open(app_path, "w") as f:
        f.write(app_code)
    print("   ✅ App Fixed: Backtest output now persists correctly.")


if __name__ == "__main__":
    fix_backtest_persistence()
