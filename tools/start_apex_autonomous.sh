...
export APEX_WF_KNOWN_GATE_MODE="${APEX_WF_KNOWN_GATE_MODE:-penalty}"
...
export APEX_WF_OPTIMIZER_COST_BPS="${APEX_WF_OPTIMIZER_COST_BPS:-25}"
export APEX_WF_OPTIMIZER_TRACE_REJECTS="${APEX_WF_OPTIMIZER_TRACE_REJECTS:-0}"
export APEX_WF_OPTIMIZER_TRACE_MAX_LINES="${APEX_WF_OPTIMIZER_TRACE_MAX_LINES:-3000}"
export APEX_WF_MAX_TRADES_SOFT="${APEX_WF_MAX_TRADES_SOFT:-650}"
